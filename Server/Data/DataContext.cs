    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Product>().HasData(
                ...
                {
                    Id = 1,
                    Title = "The Flower Art",
                    Description = "Large Abstract Flower Oil Painting On Canvas,White 3D Floral Painting,Flower Acrylic Painting,Heavy Textured Flower Art,Floral Wall Decor",
                    ImageUrl = "C:/Remya/C#Samples/BlazorECommerceApp/Server/Images/FlowerArt.JPG",
                    Price = 120.99m
                },
                new Product
                {
